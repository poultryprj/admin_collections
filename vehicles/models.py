...
class VehicleInsurance(models.Model):
    ...
    vehicle_id = models.ForeignKey(Vehicle, on_delete=models.SET_NULL, null=True)  #vehicle number FK of Vehicle
    # insurance_company = models.ForeignKey(InsuranceCompany, on_delete=models.SET_NULL, null=True)
    ...
    insurance_paid_mount = models.DecimalField(max_digits=30,decimal_places=2)
...
# class VehiclePermitType(models.Model):
#     vehicle_permit_type_id = models.AutoField(primary_key=True)
#     permit_type = models.CharField(max_length=255, unique=True)
...
class VehiclePermit(models.Model):
    ...
    # vehicle_permit_type = models.ForeignKey(VehiclePermitType, on_delete=models.SET_NULL, null=True)
