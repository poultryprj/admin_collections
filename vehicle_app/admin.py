...
class FitnessAdmin(admin.ModelAdmin):
    list_display = ('fitness_id', 'vehicle_id', 'registration_no', 'vehicle_fitness_from_date', 'vehicle_fitness_to_date', 'created_by_id', 'last_modified_by_id', 'created_on', 'last_modified_on')

    search_fields = ('fitness_id', 'vehicle_id', 'registration_no')

    list_display_links = ('fitness_id', 'vehicle_id', 'registration_no')
